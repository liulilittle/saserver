...
BOOL NPC_AirInit(int meindex)
{
    ...
    CHAR_setWorkInt(meindex, CHAR_WORK_AIRCRAFT_MODE, 1);
#endif
...
#ifdef _PLAYER_UID
    char uid[32];
    sprintf(uid, "zzzz%d", meindex);
    CHAR_setChar(meindex, CHAR_PLAYERUID, uid);
#endif // _PLAYER_UID
    return TRUE;
}
