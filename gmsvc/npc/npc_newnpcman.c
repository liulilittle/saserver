        ...
        case WINDOW_SELECTLOSTPET:
#ifdef _PET_LOSTPET
            {
                ...
                else
                {
                    ...
                    if (getStringFromIndexWithDelim(petstring[ti - 1], "|", 6, buf1, sizeof(buf1)) == FALSE)
                    {
                        return;
                    }
                    ...
                    if (getStringFromIndexWithDelim(petstring[ti - 1], "|", 4, buf1, sizeof(buf1)) == FALSE)
                    {
                        return;
                    }
...
BOOL NPC_reFindMyLostPet(int meindex, int toindex, char *buf)
{
    ...
    while (fgets(line, sizeof(line), fp) && count < 7)
    {
        ...
        if (getStringFromIndexWithDelim(line, "|", 2, petname, sizeof(petname)) == FALSE)
        {
            continue;
        }
