...
#ifdef  _ADDMAXFAMILY
#define FAMILY_MAXNUM           4000    // 家族数量
#else
...
#define FMPOINTNUM          5       // 有据点家族的最大数量
#define MANORNUM                    5
#define FAMILY_MAXHOME          5   // 家族据点
#endif
...
void ACFMCharLogin(char *charid, char *charname, int ret, int index, int floor, int fmdp,
...
//  BOOL use;                                       // 0->没使用   1->使用
    ...
    char     petname[CHARNAMELEN];      // 守护兽名称
...
typedef struct _ManorSchedule_t
{
    ...
    char szFmName[10][CHARNAMELEN];          // 家族名称
...
#define MAXFAMILYLIST 1024*1024
