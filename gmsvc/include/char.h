...
//#endif
#ifdef  _NEW_PETDEPOT
    WINDOW_MESSAGETYPE_PETDEPOTSELECT,
#endif

    WINDOW_MESSAGETYPE_POOLITEM = 107,
    WINDOW_MESSAGETYPE_POOLPET = 108,
    WINDOW_MESSAGETYPE_NEWSTREET = 109,
    WINDOW_MESSAGETYPE_NEWSTREETTYPE = 110,
    WINDOW_MESSAGETYPE_NEWSELECT = 111,
} WINDOW_MESSAGETYPE;
...
typedef enum
{
    ...
    CHAR_WINDOWTYPE_WINDOWPETSHOP_NOWND = 270,
...
#ifdef FMPKNUMBERWIN
    CHAR_WINDOWTYPE_FAMILYMAN_PKNUBER = 326,    //山猪选择PK的人数
    CHAR_WINDOWTYPE_FAMILYMAN_PKNUBER1 = 327,   //山猪选择PK的人数
#endif
