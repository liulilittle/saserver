...
#define getCharBaseValue(L,narg,charbase,num) _getCharBaseValue(L,narg,charbase,num,__func__)
const int _getCharBaseValue(lua_State *L, int narg, CharBase *charbase, int num, char *funname);
