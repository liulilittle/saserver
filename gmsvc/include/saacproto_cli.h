...
#endif
#endif
                           ) ; /* ../../doc/saacproto.html line 634 */
void saacproto_Message_recv(int fd, char* id_from, char* charname_from, char* id_to, char* charname_to, char* message, int option, int mesgid
#ifdef _NEW_STONEAGE_TYPE
#ifdef _ITEM_PET_TALK_
                            , char* outpetitemdata
#endif
