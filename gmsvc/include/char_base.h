...
typedef enum
{
    ...
    CHAR_BODY, //衣服
    CHAR_ARM,//武器
    CHAR_DECORATION1,//首饰1
    CHAR_DECORATION2,//首饰2
...
//      PROFESSION_EXP,             // 职业经验值
    ...
    CHAR_NOFAME,
#endif
    CHAR_DATEWORLDCNT,      //世界频道日期次数
    CHAR_WORLDTIME,     //世界频道时间
...
#ifdef _NEW_FS_TYPE
    CHAR_ISEFFECT,               //特效开关
    CHAR_ISPLAYER,               //屏蔽人物开关
    CHAR_ISTEAMFULL,               //队伍满员开关
    CHAR_ISSHOWPET,               //查看宠物开关
    CHAR_ISAUTOPARTY,               //自动加组队开关
    CHAR_ISALLWORLD,               //星球频道开关
    CHAR_ISDRAWEFFECT,               //特效开关
#endif // _NEW_FS_TYPE
...
typedef enum
{
    ...
    CHAR_WORK_AUTOPK_DEFINDEX,      //对方INDEX
#endif
    ...
    CHAR_WORKYAYAVOICE,
#endif
    CHAR_WORKDAMAGE,//附加伤害
    CHAR_WORKECHOTIME,//ECHO心跳封包时间
    CHAR_WORKECHONUM,//ECHO心跳封包错误次数
    CHAR_WORKBATTLEWAITCNT, //战斗超时次数
    CHAR_NPCWORKINT15,
    CHAR_NPCWORKINT16,
    CHAR_NPCWORKINT17,
    CHAR_NPCWORKINT18,
    CHAR_NPCWORKINT19,
    CHAR_NPCWORKINT20,
    CHAR_WORKAUTOPARTY,//自动组队模式
#ifdef _PLAYER_QUESTION
    CHAR_WORKPLAYERQUESTION, //玩家答题
