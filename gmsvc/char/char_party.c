...
BOOL CHAR_JoinParty(int charaindex)
{
            ...
            object = NEXT_OBJECT(object))
    {
           ...
           )
        {
            ...
            if (!CHAR_getWorkInt(targetindex, CHAR_WORK_ISNEWPARTY))
            {
    ...
    if (CHAR_getWorkInt(charaindex, CHAR_WORKPARTYMODE) == CHAR_PARTY_LEADER)
    {
        ...
        for (i = 0; i < getPartyNum(charaindex); i ++)
        {
            ...
            if (CHAR_CHECKINDEX(pindex))
            {
                ...
                {
                    CHAR_sendCToArroundCharacter(CHAR_getWorkInt(pindex, CHAR_WORKOBJINDEX));
                }

#endif // _PARTY_OBJINDEX
				FreeDischargeParty(pindex);
            }
        }
...
int getPartyNum(int charaindex)
{
    ...
    {
        oyaindex = CHAR_getPartyIndex(charaindex, 0);
    }
...
#ifdef _ADDPARTY_
void setNewParty(int charaindex)
{
    CHAR_setWorkInt(charaindex, CHAR_WORK_ISNEWPARTY, TRUE);
}
#endif