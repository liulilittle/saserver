...
static MAGIC_MagicFunctionTable MAGIC_functbl[] =
{
    ...
    { "MAGIC_Recovery_2", MAGIC_Recovery_2, 0 },
    { "MAGIC_OtherRecovery_2", MAGIC_OtherRecovery_2, 0 },
#endif
    ...
    { "MAGIC_AttMagicNew",         MAGIC_AttMagicNew, 0 },
#endif
};
...
#ifdef _TRUE_DAMAGE_MAGIC
int MAGIC_AttMagicNew(int charaindex, int toindex, int marray, int mp)
{
    int battlemode;
    ...
    {
        return MAGIC_AttMagicNew_Battle(charaindex, toindex, marray, mp);
    }
